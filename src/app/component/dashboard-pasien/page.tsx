...
export default function Home() {
  ...
  return (
    <div className="h-[92vh] sm:ml-64 bg-white">
      <div className="bg-[#28a99e] h-full px-8 py-12  ">
        ...
        <h1 className="text-[#320083] font-semibold text-lg py-4">
          Pick Your Schedule
        </h1>
        <div className="w-full max-w-full rounded-xl bg-white border-[#320083] border-2">
